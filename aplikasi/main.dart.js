...
(function dartProgram() {
  ...
  A = {JS_CONST: function JS_CONST() {
    ...
    main() {
      var t4, t5, t6, t1 = {},
        t2 = type$.String,
        t3 = type$.dynamic,
        pengeluaranList = A._setArrayType([A.LinkedHashMap_LinkedHashMap$_literal(["kategori", "Makanan", "jumlah", 50000, "tanggal", new A.DateTime(Date.now(), 0, false)._addMicroseconds$1(0 - A.Duration$(2)._duration)], t2, t3), A.LinkedHashMap_LinkedHashMap$_literal(["kategori", "Hiburan", "jumlah", 80000, "tanggal", new A.DateTime(Date.now(), 0, false)._addMicroseconds$1(0 - A.Duration$(10)._duration)], t2, t3), A.LinkedHashMap_LinkedHashMap$_literal(["kategori", "Transportasi", "jumlah", 30000, "tanggal", new A.DateTime(Date.now(), 0, false)._addMicroseconds$1(0 - A.Duration$(35)._duration)], t2, t3)], type$.JSArray_Map_String_dynamic);
      t1.selectedPeriode = t1.selectedKategori = "Semua";
      t3 = new A.main_displayPengeluaran();
      t2 = new A.main_updatePengeluaranList(t1, pengeluaranList, t3);
      t4 = document;
      t5 = t4.querySelector("#filterKategori");
      if (t5 != null) {
        t5 = J.get$onChange$x(t5);
        t6 = t5.$ti;
        A._EventStreamSubscription$(t5._target, t5._eventType, t6._eval$1("~(1)?")._as(new A.main_closure(t1, t2)), false, t6._precomputed1);
      }
      t4 = t4.querySelector("#filterPeriode");
      if (t4 != null) {
        t4 = J.get$onChange$x(t4);
        t5 = t4.$ti;
        A._EventStreamSubscription$(t4._target, t4._eventType, t5._eval$1("~(1)?")._as(new A.main_closure0(t1, t2)), false, t5._precomputed1);
      }
      t3.call$1(pengeluaranList);
    },
    main_displayPengeluaran: function main_displayPengeluaran() {
    },
    main_updatePengeluaranList: function main_updatePengeluaranList(t0, t1, t2) {
      this._box_0 = t0;
      this.pengeluaranList = t1;
      this.displayPengeluaran = t2;
    },
    main_updatePengeluaranList_closure: function main_updatePengeluaranList_closure(t0) {
      this._box_0 = t0;
    },
    main_updatePengeluaranList_closure0: function main_updatePengeluaranList_closure0(t0) {
      this.now = t0;
    },
    main_updatePengeluaranList_closure1: function main_updatePengeluaranList_closure1(t0) {
      this.now = t0;
    },
    main_updatePengeluaranList_closure2: function main_updatePengeluaranList_closure2(t0) {
      this.now = t0;
    },
    main_closure: function main_closure(t0, t1) {
      this._box_0 = t0;
      this.updatePengeluaranList = t1;
    },
  ...
  A.main_displayPengeluaran.prototype = {
    call$1(list) {
      var t1, t2, _i, item, t3, t4,
        _s19_ = "#riwayatPengeluaran";
      type$.List_Map_String_dynamic._as(list);
      t1 = document;
      t2 = t1.querySelector(_s19_);
      if (t2 != null)
      ...
      for (t2 = list.length, _i = 0; _i < list.length; list.length === t2 || (0, A.throwConcurrentModificationError)(list), ++_i) {
        ...
        t3.toString;
        t4 = J.getInterceptor$ax(item);
        B.DivElement_methods.set$text(t3, A.S(t4.$index(item, "kategori")) + " - Rp " + A.S(t4.$index(item, "jumlah")) + " - " + A.S(t4.$index(item, "tanggal")));
        t4 = t1.querySelector(_s19_);
        if (t4 != null)
  ...
  A.main_updatePengeluaranList.prototype = {
    call$0() {
      var t2, t3, now,
        filteredList = this.pengeluaranList,
        t1 = this._box_0;
      if (t1.selectedKategori !== "Semua") {
        t2 = A._arrayInstanceType(filteredList);
        t3 = t2._eval$1("WhereIterable<1>");
        filteredList = A.List_List$of(new A.WhereIterable(filteredList, t2._eval$1("bool(1)")._as(new A.main_updatePengeluaranList_closure(t1)), t3), true, t3._eval$1("Iterable.E"));
      }
      if (t1.selectedPeriode !== "Semua") {
        now = new A.DateTime(Date.now(), 0, false);
        switch (t1.selectedPeriode) {
          case "1 Minggu Terakhir":
            t1 = A._arrayInstanceType(filteredList);
            t2 = t1._eval$1("WhereIterable<1>");
            filteredList = A.List_List$of(new A.WhereIterable(filteredList, t1._eval$1("bool(1)")._as(new A.main_updatePengeluaranList_closure0(now)), t2), true, t2._eval$1("Iterable.E"));
            break;
          case "1 Bulan Terakhir":
            t1 = A._arrayInstanceType(filteredList);
            t2 = t1._eval$1("WhereIterable<1>");
            filteredList = A.List_List$of(new A.WhereIterable(filteredList, t1._eval$1("bool(1)")._as(new A.main_updatePengeluaranList_closure1(now)), t2), true, t2._eval$1("Iterable.E"));
            break;
          case "3 Bulan Terakhir":
            t1 = A._arrayInstanceType(filteredList);
            t2 = t1._eval$1("WhereIterable<1>");
            filteredList = A.List_List$of(new A.WhereIterable(filteredList, t1._eval$1("bool(1)")._as(new A.main_updatePengeluaranList_closure2(now)), t2), true, t2._eval$1("Iterable.E"));
            break;
        }
      }
      this.displayPengeluaran.call$1(filteredList);
    },
    $signature: 0
  };
  A.main_updatePengeluaranList_closure.prototype = {
    call$1(item) {
      return J.$eq$(type$.Map_String_dynamic._as(item).$index(0, "kategori"), this._box_0.selectedKategori);
    },
    $signature: 1
  };
  A.main_updatePengeluaranList_closure0.prototype = {
    call$1(item) {
      return type$.Map_String_dynamic._as(item).$index(0, "tanggal").isAfter$1(this.now._addMicroseconds$1(0 - A.Duration$(7)._duration));
    },
    $signature: 1
  };
  A.main_updatePengeluaranList_closure1.prototype = {
    call$1(item) {
      return type$.Map_String_dynamic._as(item).$index(0, "tanggal").isAfter$1(this.now._addMicroseconds$1(0 - A.Duration$(30)._duration));
    },
    $signature: 1
  };
  A.main_updatePengeluaranList_closure2.prototype = {
    call$1(item) {
      return type$.Map_String_dynamic._as(item).$index(0, "tanggal").isAfter$1(this.now._addMicroseconds$1(0 - A.Duration$(90)._duration));
    },
    $signature: 1
  };
  A.main_closure.prototype = {
    call$1(e) {
      var t1 = type$.SelectElement._as(J.get$target$x(e)).value;
      t1.toString;
      this._box_0.selectedKategori = t1;
      this.updatePengeluaranList.call$0();
    },
    $signature: 2
  };
  A.main_closure0.prototype = {
    call$1(e) {
      var t1 = type$.SelectElement._as(J.get$target$x(e)).value;
      t1.toString;
      this._box_0.selectedPeriode = t1;
      this.updatePengeluaranList.call$0();
    },
    $signature: 2
  };
  ...
  (function inheritance() {
    ...
    _inheritMany(A.Object, [A.JS_CONST, J.Interceptor, J.ArrayIterator, A.Error, A.SentinelValue, A.ListIterator, A.Iterable, A.MappedIterator, A.WhereIterator, A.TypeErrorDecoder, A.NullThrownFromJavaScriptException, A._StackTrace, A.Closure, A.MapBase, A.LinkedHashMapCell, A.Rti, A._FunctionParameters, A._Type, A._TimerImpl, A.AsyncError, A._FutureListener, A._Future, A._AsyncCallbackEntry, A.Stream, A._Zone, A.ListBase, A.DateTime, A.Duration, A.OutOfMemoryError, A.StackOverflowError, A._Exception, A.Null, A._StringStackTrace, A.StringBuffer, A.EventStreamProvider, A._EventStreamSubscription, A.ImmutableListMixin, A.FixedSizeListIterator, A._DOMWindowCrossFrame]);
  ...
  var init = {
    ...
    mangledNames: {},
    types: ["~()", "bool(Map<String,@>)", "~(Event)", "~(~())", "Null()", "@(@)", "@(@,String)", "@(String)", "Null(@)", "Null(~())", "_Future<@>(@)", "~(Object?,Object?)", "bool(Node)", "Element(Node)", "~(List<Map<String,@>>)"],
    interceptorsByTag: null,
    leafTags: null,
    arrayRti: Symbol("$ti")
  };
  A._Universe_addRules(init.typeUniverse, JSON.parse('{"PlainJavaScriptObject":"LegacyJavaScriptObject","UnknownJavaScriptObject":"LegacyJavaScriptObject","JavaScriptFunction":"LegacyJavaScriptObject","AbortPaymentEvent":"Event","ExtendableEvent":"Event","AElement":"SvgElement","GraphicsElement":"SvgElement","OpenDBRequest":"EventTarget","Request":"EventTarget","AudioElement":"HtmlElement","MediaElement":"HtmlElement","HtmlDocument":"Node","Document":"Node","CDataSection":"CharacterData","Text":"CharacterData","MathMLElement":"Element","HtmlFormControlsCollection":"HtmlCollection","JSBool":{"bool":[],"TrustedGetRuntimeType":[]},"JSNull":{"TrustedGetRuntimeType":[]},"JSArray":{"List":["1"],"Iterable":["1"]},"JSUnmodifiableArray":{"JSArray":["1"],"List":["1"],"Iterable":["1"]},"ArrayIterator":{"Iterator":["1"]},"JSNumber":{"num":[]},"JSInt":{"int":[],"num":[],"TrustedGetRuntimeType":[]},"JSNumNotInt":{"num":[],"TrustedGetRuntimeType":[]},"JSString":{"String":[],"TrustedGetRuntimeType":[]},"LateError":{"Error":[]},"ListIterator":{"Iterator":["1"]},"MappedIterable":{"Iterable":["2"],"Iterable.E":"2"},"MappedIterator":{"Iterator":["2"]},"WhereIterable":{"Iterable":["1"],"Iterable.E":"1"},"WhereIterator":{"Iterator":["1"]},"NullError":{"TypeError":[],"Error":[]},"JsNoSuchMethodError":{"Error":[]},"UnknownJsTypeError":{"Error":[]},"_StackTrace":{"StackTrace":[]},"Closure":{"Function":[]},"Closure0Args":{"Function":[]},"Closure2Args":{"Function":[]},"TearOffClosure":{"Function":[]},"StaticClosure":{"Function":[]},"BoundClosure":{"Function":[]},"_CyclicInitializationError":{"Error":[]},"RuntimeError":{"Error":[]},"_AssertionError":{"Error":[]},"JsLinkedHashMap":{"MapBase":["1","2"],"LinkedHashMap":["1","2"],"Map":["1","2"]},"_Error":{"Error":[]},"_TypeError":{"TypeError":[],"Error":[]},"_Future":{"Future":["1"]},"AsyncError":{"Error":[]},"_Zone":{"Zone":[]},"_RootZone":{"_Zone":[],"Zone":[]},"ListBase":{"List":["1"],"Iterable":["1"]},"MapBase":{"Map":["1","2"]},"int":{"num":[]},"List":{"Iterable":["1"]},"AssertionError":{"Error":[]},"TypeError":{"Error":[]},"ArgumentError":{"Error":[]},"RangeError":{"Error":[]},"IndexError":{"Error":[]},"UnsupportedError":{"Error":[]},"UnimplementedError":{"Error":[]},"ConcurrentModificationError":{"Error":[]},"OutOfMemoryError":{"Error":[]},"StackOverflowError":{"Error":[]},"_StringStackTrace":{"StackTrace":[]},"Element":{"Node":[],"EventTarget":[]},"Node":{"EventTarget":[]},"HtmlElement":{"Element":[],"Node":[],"EventTarget":[]},"AnchorElement":{"Element":[],"Node":[],"EventTarget":[]},"AreaElement":{"Element":[],"Node":[],"EventTarget":[]},"CharacterData":{"Node":[],"EventTarget":[]},"DivElement":{"Element":[],"Node":[],"EventTarget":[]},"_ChildrenElementList":{"ListBase":["Element"],"List":["Element"],"Iterable":["Element"],"ListBase.E":"Element"},"FormElement":{"Element":[],"Node":[],"EventTarget":[]},"HtmlCollection":{"ListBase":["Node"],"ImmutableListMixin":["Node"],"List":["Node"],"JavaScriptIndexingBehavior":["Node"],"Iterable":["Node"],"ListBase.E":"Node","ImmutableListMixin.E":"Node"},"_ChildNodeListLazy":{"ListBase":["Node"],"List":["Node"],"Iterable":["Node"],"ListBase.E":"Node"},"NodeList":{"ListBase":["Node"],"ImmutableListMixin":["Node"],"List":["Node"],"JavaScriptIndexingBehavior":["Node"],"Iterable":["Node"],"ListBase.E":"Node","ImmutableListMixin.E":"Node"},"SelectElement":{"Element":[],"Node":[],"EventTarget":[]},"Window":{"WindowBase":[],"EventTarget":[]},"_EventStream":{"Stream":["1"]},"_ElementEventStreamImpl":{"_EventStream":["1"],"Stream":["1"]},"FixedSizeListIterator":{"Iterator":["1"]},"_DOMWindowCrossFrame":{"WindowBase":[],"EventTarget":[]},"FilteredElementList":{"ListBase":["Element"],"List":["Element"],"Iterable":["Element"],"ListBase.E":"Element"},"VersionChangeEvent":{"Event":[]},"SvgElement":{"Element":[],"Node":[],"EventTarget":[]}}'));
  var string$ = {
